        ...
        <div className='searchResults'>      
          {hits.map(hit => (
            <div className='searchResult'>
              <img alt={hit.short_name} src={`http://el-aggregator-api-q3hl2qd3ia-uk.a.run.app/api/v1/images/${hit.sofifa_id}?q=player`}/>
    ...
    return(
      <div className='autoComplete'>  
        ...
        <div className='searchResults'>      
          {hits.map(hit => (
            <div className='searchResult'>
              <img alt={hit.name} src={`http://el-aggregator-api-q3hl2qd3ia-uk.a.run.app/api/v1/images/${hit.ext}?q=team`}/>
