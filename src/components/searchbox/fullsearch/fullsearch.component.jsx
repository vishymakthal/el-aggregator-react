...
class FullSearch extends React.Component {
   ...
   handleSubmit (event) {
    fetch(`http://el-aggregator-api-q3hl2qd3ia-uk.a.run.app/api/v1/`)
   }
        ...
        <div className='searchResults'>      
          {this.state.hits.map(hit => (
            <div className='searchResult'>
              <img src={`http://el-aggregator-api-q3hl2qd3ia-uk.a.run.app/api/v1/images/${hit.sofifa_id}?q=player`}/>
